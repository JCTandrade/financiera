...
import com.superfinanciera.mycrud.service.Impl.TipoTransaccionService;
...
class TipoTransaccionControllerTest {
    ...
    @InjectMocks TipoTransaccionController transaccionController;
    ...
    @Test
    void testObtenerTipoTransaccionOk() {
        Mockito.when(tipoTransaccionService.obtenerListaTipoTransacion()).thenReturn(responseDto);

        ResponseEntity<ResponseDto> responseEntity = transaccionController.obtenerTipoTransaccion();
